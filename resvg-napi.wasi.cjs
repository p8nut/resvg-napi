// napi-rs-artifact-metadata:{"version":2,"rootEntry":"index.js","exports":["ClipPath","Filter","Font","FontDatabase","FontFace","Image","ImageKindGif","ImageKindJpeg","ImageKindPng","ImageKindWebp","LinearGradient","Mask","Pattern","PositionedGlyph","RadialGradient","Resvg","Span","SvgNode","Text","TextChunk","TextSpan","AlignmentBaseline","BlendMode","ColorChannel","ColorInterpolation","DominantBaseline","EdgeMode","FillRule","FontFaceStyle","FontOpticalSizing","FontStretch","FontStyle","ImageRendering","LengthAdjust","LineCap","LineJoin","MaskType","MorphologyOperator","NodeKind","PaintOrder","renderAsync","setLogLevel","ShapeRendering","SpreadMethod","Stretch","takeLogs","TextAnchor","TextRendering","TurbulenceKind","WritingMode"],"managedRootEntries":["browser.js","index.js","resvg-napi.wasm","resvg-napi.debug.wasm"]}
/* eslint-disable */
...
let __wasmFilePath = __nodePath.join(__dirname, 'resvg-napi.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'resvg-napi.wasm32-wasi.debug.wasm')
...
module.exports.ClipPath = __napiModule.exports.ClipPath
module.exports.Filter = __napiModule.exports.Filter
module.exports.Font = __napiModule.exports.Font
module.exports.FontDatabase = __napiModule.exports.FontDatabase
module.exports.FontFace = __napiModule.exports.FontFace
module.exports.Image = __napiModule.exports.Image
module.exports.ImageKindGif = __napiModule.exports.ImageKindGif
module.exports.ImageKindJpeg = __napiModule.exports.ImageKindJpeg
module.exports.ImageKindPng = __napiModule.exports.ImageKindPng
module.exports.ImageKindWebp = __napiModule.exports.ImageKindWebp
...
module.exports.PositionedGlyph = __napiModule.exports.PositionedGlyph
module.exports.RadialGradient = __napiModule.exports.RadialGradient
module.exports.Resvg = __napiModule.exports.Resvg
module.exports.Span = __napiModule.exports.Span
module.exports.SvgNode = __napiModule.exports.SvgNode
module.exports.Text = __napiModule.exports.Text
module.exports.TextChunk = __napiModule.exports.TextChunk
module.exports.TextSpan = __napiModule.exports.TextSpan
module.exports.AlignmentBaseline = __napiModule.exports.AlignmentBaseline
module.exports.BlendMode = __napiModule.exports.BlendMode
module.exports.ColorChannel = __napiModule.exports.ColorChannel
module.exports.ColorInterpolation = __napiModule.exports.ColorInterpolation
...
module.exports.ImageRendering = __napiModule.exports.ImageRendering
module.exports.LengthAdjust = __napiModule.exports.LengthAdjust
module.exports.LineCap = __napiModule.exports.LineCap
module.exports.LineJoin = __napiModule.exports.LineJoin
module.exports.MaskType = __napiModule.exports.MaskType
module.exports.MorphologyOperator = __napiModule.exports.MorphologyOperator
...
module.exports.Stretch = __napiModule.exports.Stretch
...
module.exports.WritingMode = __napiModule.exports.WritingMode
